...
* Se compreende a diferença entre pacote e aplicação
* Se entende o conceito de serviço
* Se consegue localizar documentação por conta própria
* Se consegue investigar problemas utilizando logs
* Se consegue aplicar shell script em tarefas administrativas
...
3. Qual a diferença entre instalar e executar uma aplicação?
4. O que é um serviço?
5. Qual a diferença entre um programa comum e um serviço?
6. O que é o systemd?
7. Como descobrir se um serviço está ativo?
8. Onde normalmente ficam os arquivos de configuração?
9. O que é um log?
10. Para que servem os logs?
11. Como você investigaria um problema em um serviço?
12. Qual atividade foi mais difícil?
13. O que você precisou pesquisar além do material sugerido?

---

# Critério de aprovação

* [ ] Consegue instalar e remover aplicações
* [ ] Consegue identificar e analisar serviços
* [ ] Consegue localizar arquivos de configuração
* [ ] Consegue consultar logs
* [ ] Script funcional
* [ ] Entregou o resumo

Caso contrário, os tópicos deverão ser reforçados antes da introdução do PostgreSQL.
