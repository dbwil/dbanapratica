...
Durante o encontro, avaliar principalmente:

## 1. Estrutura do PostgreSQL

Verificar se você consegue explicar a relação:
...
Não é necessário memorizar a sintaxe inteira.

O importante é conseguir pesquisar e entender o que está fazendo.

## 3. Constraints

Verificar se você consegue explicar por que as constraints existem e interpretar os erros produzidos quando uma regra é violada.

## 4. Permissões

Verificar se você consegue distinguir:
...
e identificar onde está o problema quando uma operação é recusada.

## 5. Autonomia

Observar:

- se pesquisa antes de pedir ajuda;
- se consulta a documentação;
- se interpreta mensagens de erro;
- se registra as descobertas;
- se consegue explicar o que fez.
...
- [ ] Compreende a diferença entre instância, database, schema e tabela.
- [ ] Consegue listar schemas e tabelas.
- [ ] Consegue identificar o schema utilizado.

**Aprovação:** consegue explicar a estrutura sem confundir database, schema e tabela.

**Reprovação:** ainda trata database, schema e tabela como níveis equivalentes ou intercambiáveis.

---

## Tabelas e dados

- [ ] Consegue criar uma tabela.
- [ ] Compreende colunas e tipos de dados.
- [ ] Consegue inserir registros.
- [ ] Consegue consultar registros.
- [ ] Consegue alterar registros.
- [ ] Consegue remover registros.

**Aprovação:** consegue realizar as operações básicas com pesquisa e interpretar seus resultados.

**Reprovação:** não consegue realizar as operações mesmo utilizando a documentação.

---

## Constraints

- [ ] Compreende `PRIMARY KEY`.
- [ ] Compreende `NOT NULL`.
- [ ] Compreende `UNIQUE`.
- [ ] Compreende `CHECK`.
- [ ] Compreende `DEFAULT`.
- [ ] Consegue interpretar um erro de constraint.

**Aprovação:** consegue explicar qual regra foi violada e por quê.

**Reprovação:** trata constraints apenas como comandos a serem copiados, sem compreender sua finalidade.

---

## Permissões

- [ ] Diferencia acesso ao database de acesso a objetos.
- [ ] Consegue consultar privilégios.
- [ ] Consegue conceder privilégios básicos.
- [ ] Consegue testar os privilégios.
- [ ] Compreende o conceito de menor privilégio.

**Aprovação:** consegue preparar `appuser` para trabalhar com a tabela sem conceder privilégios administrativos desnecessários.

**Reprovação:** concede privilégios excessivos apenas para fazer a aplicação funcionar.
...
- [ ] Registra as dificuldades no diário.
- [ ] Consegue explicar o que fez e por que fez.

**Aprovação:** demonstra capacidade de pesquisar e chegar a uma solução.

**Reprovação:** depende constantemente de instruções passo a passo para tarefas já trabalhadas.

---

# Resultado esperado da quinzena

Ao terminar esta quinzena, você deverá conseguir olhar para um database PostgreSQL e entender sua estrutura básica:
...
E também deverá começar a raciocinar sobre permissões em diferentes níveis:
...
O objetivo desta quinzena não é transformar você em desenvolvedor SQL.

O objetivo é fazer com que você consiga administrar uma estrutura simples de PostgreSQL, entender os objetos existentes e investigar por que uma determinada role consegue ou não realizar uma operação.

Esse conhecimento será utilizado nas próximas quinzenas para avançarmos para configuração, manutenção, monitoramento e backup.
